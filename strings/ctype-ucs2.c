...
static void
my_hash_sort_utf16_nopad(CHARSET_INFO *cs, const uchar *s, size_t slen,
                   ulong *nr1, ulong *nr2)
{
  my_wc_t wc;
  my_charset_conv_mb_wc mb_wc= cs->cset->mb_wc;
                   ...
                   ulong *nr1, ulong *nr2)
{
  ...
  my_hash_sort_utf16_nopad(cs, s, e - s, nr1, nr2);
}
...
static void
my_hash_sort_utf16_nopad_bin(CHARSET_INFO *cs,
                       ...
                       const uchar *pos, size_t len, ulong *nr1, ulong *nr2)
{
  ...
  my_hash_sort_utf16_nopad_bin(cs, pos, end - pos, nr1, nr2);
}
                   ...
                   ulong *nr1, ulong *nr2)
{
  ...
  while (e > s + 3 && e[-1] == ' ' && !e[-2] && !e[-3] && !e[-4])
    e-= 4;
  my_hash_sort_utf32_nopad(cs, s, e - s, nr1, nr2);
}
...
static void my_hash_sort_ucs2_nopad(CHARSET_INFO *cs, const uchar *s, size_t slen,
                                    ulong *nr1, ulong *nr2)
{
  my_wc_t wc;
  int res;
			      ...
			      ulong *nr1, ulong *nr2)
{
  ...
  my_hash_sort_ucs2_nopad(cs, s, e - s, nr1, nr2);
}
...
static
void my_hash_sort_ucs2_nopad_bin(CHARSET_INFO *cs __attribute__((unused)),
			   ...
			   const uchar *key, size_t len,ulong *nr1, ulong *nr2)
{
  ...
  my_hash_sort_ucs2_nopad_bin(cs, key, end - key, nr1, nr2);
}
